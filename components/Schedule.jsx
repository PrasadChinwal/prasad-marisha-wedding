...
function TimeSlots({ day, className }) {
  return (
    <ol
      ...
      className={clsx(
        className,
        'space-y-8 bg-white/60 py-14 px-10 text-center shadow-xl shadow-rose-900/5 backdrop-blur'
      )}
    >
    ...
    <section id="schedule" aria-label="Schedule" className="py-10 sm:py-20">
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          <h2 className="font-display text-4xl font-medium tracking-tighter text-rose-600 sm:text-5xl">
            Schedule:
          </h2>
        </div>
      </Container>
